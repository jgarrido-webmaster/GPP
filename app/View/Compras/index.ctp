<div class="compras index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('formaPago'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($compra['Compra']['descuento']); ?>&nbsp;</td>
		<td><?php echo h($compra['Compra']['total']); ?>&nbsp;</td>
		<td><?php echo h($compra['Compra']['formaPago']); ?>&nbsp;</td>
		<td><?php echo h($compra['Compra']['documento']); ?>&nbsp;</td>
		<td><?php echo h($compra['Compra']['aprobado']); ?>&nbsp;</td>
